...
#[derive(Debug)]
pub struct CryptoFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoFlow processing");
    
    let mut processor = CryptoFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoFlowProcessor::new(false);
